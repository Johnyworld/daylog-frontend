...
export default ({ icon, size, color="#222" }) => {
    ...
    if ( icon === "hamburger") return (
        <svg xmlns="http://www.w3.org/2000/svg" 
            ...
            height={sizeNum} 
            viewBox={`0 0 ${sizeNum} ${sizeNum}`}>
            <line stroke={color} x1="0.3" y1="0.4" x2="20.5" y2="12.4"/>
            <line stroke={color} x1="0.3" y1="8.7" x2="20.5" y2="20.7"/>
            <line stroke={color} x1="0.3" y1="16.9" x2="6.7" y2="20.7"/>
            <line stroke={color} x1="14.1" y1="0.4" x2="20.5" y2="4.2"/>
        </svg>
    )
