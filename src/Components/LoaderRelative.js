    ...
    return (
        <Container>
            <svg xmlns="http://www.w3.org/2000/svg" 
                ...
                height="40"
                viewBox={`0 0 32 32`}>
                <path fill={Theme.c_gray} d="M11.8,28.6l0.8-2.1c4.4-10.7,12-13.4,18.9-14.7l0.5-0.1v0.5c0,4.4-1.8,9.9-10.2,10.8c-5.4,0.5-6.8,2.1-8.1,3.5
                ...
                <path fill={Theme.c_gray} d="M24.3,14.4c0.2-1.2,0.3-2.5,0.2-3.9c-0.1-3.7-2-6.5-5.1-7.8C15,1.1,7.5,1.5,4.2,6.2c-1,1.4-0.8,2.2-0.3,3
                ...
                <path fill={Theme.c_gray} d="M12.7,28.7c-0.6,0.8-1.9,1.4-1.9,1.4c2.8-7.6,8.1-11.5,12.4-13.3C21.6,17.8,14.5,23.5,12.7,28.7z"/>
            </svg>
        </Container>
    )
}